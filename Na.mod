...
PROCEDURE settables(v) {
    ...
    : Hanson2004 shifted activation & inactivation parameters by 5mV in the depolarized direction;
    :    maximum sodium conductance was set at 2 nS/um2 with uniform distribution
    :    leading to 5nA in the soma during an AP and needed to generate a rise-to-peak of 0.2ms
    : NOTE did not implement this offset because it is unclear whether EP neurons have that property
	vadj  = v - rest
