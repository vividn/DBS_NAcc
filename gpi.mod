...
Used 1.47ohm-m2 from HansonSmith2004 for the membrane conductance, which
yields 6.8027e-5 mho/cm2.
...
PARAMETER {
    v (mV)
	dt (ms)
    gpas  = 6.8027e-5 (mho/cm2) <0,1e9>     : was 7.84112e-05 (mho/cm2) <0,1e9>
	epas  = -60 (mV)                        : was -58.4477 (mV)
	celsius
}
